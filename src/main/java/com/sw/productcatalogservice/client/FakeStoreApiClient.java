package com.sw.productcatalogservice.client;
...
public class FakeStoreApiClient {
    ...
    public Boolean validateResponse(ResponseEntity<FakeStoreProductDto> fakeStoreProductDtoResponseEntity){
        if(fakeStoreProductDtoResponseEntity.getBody()!=null && fakeStoreProductDtoResponseEntity.getStatusCode()== HttpStatus.valueOf("200")){
            return true;
        }
        return false;
    }
